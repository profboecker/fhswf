%% =============================================================
%% fhswf-seminarpaper.tex
%% Pandoc/RMarkdown-LaTeX-Template fuer FHSWF-Seminararbeiten
%%
%% Anpassungen schnell finden:
%%   Deckblatt-Layout ........... \def\cover      (suche weiter unten)
%%   Ehrenwörtliche Erklärung ... \def\pageone    (suche weiter unten)
%%   Checkliste ................. \def\pagetwo    (suche weiter unten)
%%   Zusammensetzung Deckblatt .. Abschnitt: ZUSAMMENSETZUNG
%%   Kopf- und Fusszeilen ....... Abschnitt: HEADERS AND FOOTERS
%%   Schriftarten ............... Abschnitt: FONT
%%   Ueberschriftenstile ........ Abschnitt: SECTION TITLES
%%   Link- und Zitationsfarben .. Abschnitt: FHSWF LINK COLORS
%%   Literaturstil .............. Abschnitt: BIBLIOGRAPHY
%%   Seitenraender .............. \geometry{...}  (suche weiter unten)
%% =============================================================
...
% ---------------------------------------------------------------
% ENCODING & FONT-ENGINE
% pdfLaTeX: laedt fontenc (T1) + inputenc (utf8) automatisch.
% XeLaTeX / LuaLaTeX: nutzt unicode-math; Schriften per YAML
%   mainfont:, sansfont:, monofont: setzen.
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
% PDF-METADATEN & HYPERREF
% pdftitle, pdfauthor, pdfkeywords → aus YAML title/author/keywords
% colorlinks, linkcolor usw. → YAML oder Fallback hier
% HINWEIS: Linkfarben werden weiter unten im Abschnitt
%   FHSWF LINK COLORS endgueltig ueberschrieben.
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
% SEITENRAENDER  (Standard: 2,5 cm rundum)
% Aendern per YAML:  geometry: [left=3cm, right=2cm, ...]
% Oder direkt im \geometry{...}-Fallback weiter unten.
% ---------------------------------------------------------------
$if(geometry)$
...
% ---------------------------------------------------------------
% SPRACHE
% YAML lang:   de-de | en-gb | en-us  (Silbentrennung, babel)
% YAML german: true  → alle generierten Texte auf Deutsch
% YAML german: false → Englisch (Standard)
% ---------------------------------------------------------------
$if(lang)$
\ifnum 0\ifxetex 1\fi\ifluatex 1\fi=0 % if pdftex
...
%% =============================================================
%% FHSWF STYLE DEFINITIONS
%% Alle institutsspezifischen Anpassungen in diesem Abschnitt.
%% =============================================================

%% CAPTIONS
% Stil: fettes Label, kursiver Text, Doppelpunkt als Trennzeichen.
% Aendern: \DeclareCaptionStyle{italic}-Optionen anpassen.
%   labelfont={bf} = fett,  textfont={it} = kursiv
...
%% FONT
% Sans-Serif:          TeX Gyre Heros  (\RequirePackage{tgheros})
% Monospace (Code):    Bera Mono       (\RequirePackage{beramono})
% Serifen / Mathematik: Palatino       (\RequirePackage{mathpazo})
% Aendern: die RequirePackage-Zeilen durch gewuenschte Pakete ersetzen.
\RequirePackage{tgheros}
\RequirePackage{beramono}
\RequirePackage{mathpazo}

%% HEADERS AND FOOTERS
% Kopfzeile links:   Dokumenttitel  (\lhead)
% Fusszeile rechts:  Seitenzahl     (\rfoot)
% Fusszeile links:   Autoren + Datum (\lfoot, weiter unten nach \author gesetzt)
% Aendern: \lhead{...}, \rfoot{...} und \lfoot{...} anpassen.
...
%% SECTION TITLES
% \section:    15/17 pt, fett, Sans-Serif
% \subsection: 12/14 pt, fett, Sans-Serif
% Schriftgroesse: \fontsize{size}{baselineskip} in \titleformat anpassen.
% Abstaende:      \titlespacing{Befehl}{links}{vor}{nach}
%   *5 = 5-facher \baselineskip, *1 = einfacher \baselineskip
...
%% TITLE PAGE
% Das Deckblatt besteht aus bis zu drei Seiten:
%   \cover   — Titelseite mit Logo, Titelkasten, Kurs, Stadt/Datum
%   \pageone — Ehrenwörtliche Erklärung (DE/EN)
%   \pagetwo — Checkliste (DE/EN)
%
% Die Zusammensetzung wird weiter unten in \def\titlepage gesteuert.
% Relevante YAML-Variablen:  german: true|false   course:   supervisor:   city:
\def\Date{\number\day}
...
% --- DECKBLATT (\cover) -----------------------------------------
% Logo-Positionen (textpos-Einheit = 1 cm):
%   FHSWF-Logo oben links:     \placefig{2}{1.5}{width=5cm}{FHSWF}
%   Claim-Logo unten rechts:   \includegraphics[height=1cm]{WirGebenImpulse}
% Titelkasten-Breite:          \parbox{14cm}{...}  — 14 cm hier aendern
% Institutsname (DE/EN):       gesteuert durch YAML german: true|false
% Kurs, Gutachter:             YAML course:  supervisor:
% Stadt und Datum:             YAML city:
...
% --- EHRENWÖRTLICHE ERKLARUNG (\pageone) -----------------------
% Fliesstext der Erklärung direkt in den Textblöcken unten bearbeiten.
% DE-Text: $if(german)$-Block,  EN-Text: $else$-Block.
% YAML city: erscheint in der Datumszeile.
% Wird eingebunden bei: YAML declaration: true  (oder checklist: true)
...
% --- CHECKLISTE (\pagetwo) --------------------------------------
% Checklistenpunkte in den \begin{todolist}...\end{todolist}-Bloecken bearbeiten.
% Neuer Punkt: \item Text  (innerhalb des passenden todolist-Blocks).
% Neuer Abschnitt: todolist-Block mit \textbf{...}-Header kopieren.
% DE-Text: $if(german)$-Block,  EN-Text: $else$-Block.
% Wird eingebunden bei: YAML checklist: true
...
% --- ZUSAMMENSETZUNG DES DECKBLATTS ----------------------------
% Standard:                   nur cover
% YAML declaration: true   →  cover + pageone (Erklärung)
% YAML checklist:   true   →  cover + pageone + pagetwo
% YAML blind:       true   →  nur Titelzeile (anonyme Einreichung)
% YAML cover:       false  →  nur pageone + Titel (kein Deckblatt)
\def\titlepage{{\cover}}
...
%% SPACING
% Zeilenabstand Fliesstext: \textspacing = \onehalfspacing (1,5-fach)
% Zeilenabstand Code-Bloecke: \codespacing = \singlespacing (einfach)
% Aendern: \onehalfspacing → z.B. \doublespacing
...
%% FHSWF LINK COLORS
% Ueberschreibt die generischen Hyperref-Einstellungen von oben.
% Farben aendern: linkcolor, urlcolor, citecolor im \hypersetup-Block unten.
%   darkblue = RGB(0, 0, 154) — in \definecolor direkt unten anpassen.
...
%% BIBLIOGRAPHY
% Standard: authoryear-comp-Stil, Biber-Backend (biblatex).
% Stil aendern:  style= in der \@ifpackageloaded-Zeile unten.
% Autoren im Zitat:  minnames=1, maxnames=3 → "Autor et al." ab 4 Autoren
% Autoren im Verzeichnis:  maxbibnames=99 → alle Autoren ausgeben
% DOI/ISBN/URL in Ausgabe:  doi=false  isbn=false  url=true
